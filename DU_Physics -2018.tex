...
\draw (0,-1)--(4,-1);
\draw (0,-2)--(4,-2);
 \draw[red, thick,reverse directed] (1.5,0)--(.5,1);
 \draw[red, thick,reverse directed] (2,-1) -- (1.5,0);
  \draw[red, thick,reverse directed] (3.5,-2) -- (2,-1);
  \node at (3,.3){বেগ $v_{1}$};
   \node at (3,-.7){বেগ $v_{2}$};
    \node at (.8,-1.5){বেগ $v_{3}$};
\end{tikzpicture}
\end{center}
...
\question  গ্রহের গতির ক্ষেত্রে – \say{একটি নক্ষত্র থেকে গ্রহকে সংযোককারী সরলরেখা সমান সময়ে সমান ক্ষেত্রফল অতিক্রম করে} - এটি কোন নীতির সরাসরি ফলাফল? (In planetary motions - \say{the line joining the star to the planet sweeps out equal areas in equal times}. This is direct principle of which principle? )
