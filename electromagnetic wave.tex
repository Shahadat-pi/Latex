...
\usepackage{tikz,bm,relsize,amsmath}
...
\begin{center}
  \begin{tikzpicture}[x={(-10:1cm)},y={(90:1cm)},z={(210:1cm)}]
    ...
    % Waves
    \draw[thick,green] plot[domain=0:4.5,samples=200] (\x,{cos(deg(pi*\x))},0);
    \draw[gray,thick,red] plot[domain=0:4.5,samples=200] (\x,0,{cos(deg(pi*\x))});
    % Arrows
    \foreach \x in {0.1,0.3,...,4.4} {
      \draw[->,help lines,orange] (\x,0,0) -- (\x,{cos(deg(pi*\x))},0);
  ...
  \end{minipage}
\end{center}
\textbf{\textit{Maxwell's Equations:}} Differential forms\\

\[01.\,\nabla\cdot E = \dfrac{\rho}{\varepsilon_{0}}\quad
02. \,\nabla\cdot B =0\quad
03. \,\nabla\times E = -\dfrac{\partial B}{\partial t}\quad
04. \,\nabla\times B = \mu_{0}\Bigg(J+\varepsilon_{0}\dfrac{\partial E}{\partial t}\Bigg)
\]
\end{document}
